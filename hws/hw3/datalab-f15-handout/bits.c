 ...
 */
int copyLSB(int x) {
  // Shift furthestmost bit to the left highest value position
  // then back to its original position
  //
  // This works because of how right-shift's are arithmatic
  // shifting only 31 registers - not 32 - leaves the sign bit untouched
  return ((x <<31)>>31);
}
/* 
